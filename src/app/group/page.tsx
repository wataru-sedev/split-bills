...
export default function GroupPage () {
  ...
  return(
    <div className="flex justify-center" >
      <div className="w-96 bg-white rounded-xl p-6 flex flex-col gap-5 items-center">
        ...
        <button className="w-full bg-gray-300 text-gray-700 rounded px-4 py-2 hover:shadow-md hover:cursor-pointer" >明細を見る</button>
